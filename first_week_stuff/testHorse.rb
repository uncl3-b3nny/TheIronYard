 ...
 # build race loop
 # speed * distance
 # break when distance traveled > distance
 # winner == longest distance
 # if tie, lower starting position wins
...
total = bots + humans
  while total < 1 
    ...
    while n < humans 
      ...
      name = gets.chomp
      if name == ""
        puts "It looks like you failed to enter a name for your jockey. But that's ok, we'll just call him/her Jockey #{m}."
        horse.name = "Jockey_#{m}"
